...
#                       
#                       Version 1.0 : This is an update to Gas.py which has been used for the
#                       previous work on the Raspberry Pi4.  This code simply reads and returns
#                       returns the electriode reading without averaging.  We use this to
#                       perform electrode offset calibrations.
#                       ***Perhaps modify this code to be the only one used by AtMoS3
